...
#### W1: Smile for the Camera: Selfies
...
I initially assigned only Jenna Gurfinkel's article because it's packed with references to other sources that you are presumably also going to want to explore. But as I was rereading it, I decided to add one other recent article that came to mind, that adds a different perspective to the discussion of social media, cameras, and smiling: a **Guardian** article about the use of facial recognition as a tool of social control in contemporary China. So in some ways, this week we could think about not just the **smile** but the **face** in social media, as a locus of social, cultural, and political power.
